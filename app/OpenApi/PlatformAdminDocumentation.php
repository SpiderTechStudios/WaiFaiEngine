...
class PlatformAdminDocumentation
{
    #[OA\Get(
        ...
        responses: [
            new OA\Response(response: 200, description: 'Routers'),
            new OA\Response(response: 403, description: 'Not a platform admin', content: new OA\JsonContent(ref: '#/components/schemas/ErrorResponse')),
        ]
    )]
    ...
    #[OA\Get(
        ...
        responses: [
            new OA\Response(response: 200, description: 'Router and company'),
